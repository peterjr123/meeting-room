...
export default function RecurringReservationInfo({ reservedData, onDeleteReserved, isOwned }
    : { reservedData: ReccuringReservationData, onDeleteReserved: (data: ReccuringReservationData) => void, isOwned: boolean }) {
    const onConfirm = () => {
